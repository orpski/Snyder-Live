// SNYDER GOLF v5.20 League Money display repair
...
(function(){
  ...
  function isPlayerRow(row){
    ...
    // The original League row has a hidden entry cell, but v5.20 removes it visually.
  ...
  function ensureEntryNote(table){
    ...
    table.setAttribute('data-money-entry-note','v5.20');
    try{
  ...
  function patch(){
    ...
    try{
      ...
      headers.forEach(function(header){
        ...
        kids(table).forEach(function(row){
          ...
          // v5.20: make the repair idempotent. v4.16 overwrote the Entry cell with Rounds,
          ...
          row.setAttribute('data-money-repaired','v5.20');
    ...
    }catch(e){console.warn('Snyder money fix v5.20 skipped safely',e);}
  }
  function schedule(){
    if(scheduled)return;
    scheduled=true;
