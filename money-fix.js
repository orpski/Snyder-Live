// SNYDER GOLF v5.17 League Money display repair
...
(function(){
  ...
  function isPlayerRow(row){
    ...
    // The original League row has a hidden entry cell, but v5.17 removes it visually.
  ...
  function patch(){
    ...
    try{
      ...
      headers.forEach(function(header){
        ...
        kids(table).forEach(function(row){
          ...
          // v5.17: make the repair idempotent. v4.16 overwrote the Entry cell with Rounds,
          ...
          if(row.getAttribute('data-money-base-rounds')!==null){
            ...
            var alreadyRepaired=row.getAttribute('data-money-repaired')==='v5.17' || row.getAttribute('data-money-repaired')==='v5.16' || row.getAttribute('data-money-repaired')==='v5.15' || row.getAttribute('data-money-repaired')==='v5.14' || row.getAttribute('data-money-repaired')==='v5.13' || row.getAttribute('data-money-repaired')==='v5.12' || row.getAttribute('data-money-repaired')==='v5.11' || row.getAttribute('data-money-repaired')==='v5.10' || row.getAttribute('data-money-repaired')==='v5.09' || row.getAttribute('data-money-repaired')==='v5.08' || row.getAttribute('data-money-repaired')==='v5.07' || row.getAttribute('data-money-repaired')==='v5.06' || row.getAttribute('data-money-repaired')==='v5.05' || row.getAttribute('data-money-repaired')==='v5.04' || row.getAttribute('data-money-repaired')==='v5.03' || row.getAttribute('data-money-repaired')==='v5.02' || row.getAttribute('data-money-repaired')==='v5.01' || row.getAttribute('data-money-repaired')==='v5.00' || row.getAttribute('data-money-repaired')==='v4.101' || row.getAttribute('data-money-repaired')==='v4.100' || row.getAttribute('data-money-repaired')==='v4.99' || row.getAttribute('data-money-repaired')==='v4.98' || row.getAttribute('data-money-repaired')==='v4.97' || row.getAttribute('data-money-repaired')==='v4.96' || row.getAttribute('data-money-repaired')==='v4.95' || row.getAttribute('data-money-repaired')==='v4.94' || rowText.indexOf(' sweep ')!==-1 || cleanText(original[3]).toLowerCase().indexOf('sweep')!==-1;
            if(alreadyRepaired){
          ...
          row.setAttribute('data-money-repaired','v5.17');
    ...
    }catch(e){console.warn('Snyder money fix v5.17 skipped safely',e);}
  }
  function schedule(){
    if(scheduled)return;
    scheduled=true;
